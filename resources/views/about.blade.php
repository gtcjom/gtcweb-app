    ...
    <section id="about" class="about">
        ...
        <div class="about-container">
            ...
            <div class="about-right-content">
                <img src="img/team.png" alt="About Image" srcset=""
                    style="width: 75%; z-index: -1; margin-bottom: 35px;">
                <div class="onetwo"
                    style="position: relative; display: flex; justify-content: space-between; align-items: left; text-align: left;">
                    <div class="one"
                        style="background-color: #fff; border-radius: 5px; margin: 10px; margin-right: 25px; padding: 10px; box-shadow: 0 31px 32px rgba(0, 0, 0, 0.1);">
                        ...
                        <button class="btn btn-gradient btn-shadow btn-rounded btn-transition" id="btn-Details">Full
                            Details</button>
                    </div>
                    <div class="two"
                        style="background-color: #fff; border-radius: 5px; margin: 10px; margin-right: 25px; padding: 10px; box-shadow: 0 31px 32px rgba(0, 0, 0, 0.1);">
                        ...
                        <i class="fa fa-long-arrow-right fa-lg" aria-hidden="true"
                            style="padding: 10px; color: #00bfff; cursor: pointer;"></i>
                    </div>
                </div>
            </div>
        </div>
