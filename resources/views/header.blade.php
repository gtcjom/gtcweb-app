<header class="header">
    ...
    <div class="nav-login sm:fixed sm:top-0 sm:right-0 p-4 text-right z-5">
        @if (Route::has('login'))
            @auth
            <a href="{{ url('/dashboard') }}" class="fixed top-6 right-4 z-50 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 p-3 rounded-full bg-gray-200 dark:bg-gray-800 user-icon">
